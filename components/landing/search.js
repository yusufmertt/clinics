      ...
      <form>
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-12">
            <h1 class="md:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">
          ...
          <div class="flex lg:w-2/3 w-full md:flex-row flex-col mx-auto px-8 md:space-x-4 md:space-y-0 space-y-4 md:px-0 items-end">
            ...
            <Link href="/clinics">
            <a class="text-white bg-brightPrimary border-0 py-2 px-8 focus:outline-none hover:bg-darkPrimary rounded text-lg w-full md:w-2/3">
              Search Clinics
            </a>
            </Link>
          </div>
