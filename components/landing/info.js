            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg shadow-md shadow-gray-200">
                ...
                <p className="leading-relaxed text-base">
                  Get your rhinoplasty operation done in full-fledged hospitals
                  by best doctors in Turkey.
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/clinics">
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg shadow-md shadow-gray-200">
                ...
                <p className="leading-relaxed text-base">
                  Get best quality for best price in dental operations like
                  implants and jaw surgeries.
                </p>
              </div>
            </div>
          </Link>
