            ...
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md " key={procedure.slug}>
              ...
              <div className="p-5">
                ...
                <Link href={`/procedures/${procedure.slug}`}>
                  <a
                    href="#"
                    className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-brightPrimary rounded-lg hover:bg-darkPrimary focus:ring-4 focus:outline-none focus:ring-purple-300"
                  >
                    Find Clinics
                    <svg
                      aria-hidden="true"
